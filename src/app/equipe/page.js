...
const columnists = [
  ...
  {
    idSlug: 'sofia-dalessandro',
    name: "Sofia D’ Alessandro",
    roleTag: 'Colunista de Criação & Estética',
    subtitle: 'Colunista de Expressão Criativa, Sensibilidade Visual e Comportamento',
    initials: 'SD',
    image: '',
    email: 'dalessandrosol6@gmail.com',
    phone: null,
    linkedin: null,
    website: null,
    areas: 'Direção Criativa, Design Conceitual, Expressão Artística e Estudos de Tendências',
    formation: 'Pesquisadora de Processos Criativos, Estética Visual e Comunicação Sensível',
    formationLabel: 'Linha de Pesquisa',
    bio: 'Articulista dedicada ao diálogo entre a estética contemporânea e a profundidade emocional do pensamento humano. Com um olhar analítico, perspicaz e metódico para a composição artística e os fenômenos culturais, investiga como a criatividade autêntica transcende o efêmero para tocar o essencial. Desenvolve ensaios e matérias que valorizam a disciplina nos processos criativos, a harmonia dos detalhes e a responsabilidade expressiva na comunicação moderna.',
    signatureTitle: "Por Sofia D’ Alessandro",
    signatureText: 'Articulista de Criação e Comportamento. Dedicada a investigar as manifestações da sensibilidade contemporânea, combinando intuição expressiva com rigor reflexivo.',
    color: 'linear-gradient(135deg, #db2777, #9333ea)'
  },
  {
    idSlug: 'amancio-oliveira',
    name: 'Amâncio de Oliveira Neto',
    ...
    linkedin: null,
    website: null,
    areas: 'Direitos de Cidadania, Apoio Comunitário, Mediação Social e Relações Interpessoais',
    formation: 'Articulador Social, Relações Institucionais e Fortalecimento Comunitário',
    formationLabel: 'Foco Editorial',
    bio: 'Voz ativa voltada à defesa da integridade nas relações humanas e ao fortalecimento dos laços comunitários. Caracteriza-se por uma postura firme, autêntica e de lealdade irrestrita aos princípios de justiça e fraternidade. Suas abordagens no Jornal Arcanjo priorizam o diálogo transparente, a superação de adversidades coletivas e o resgate da confiança mútua, compreendendo que a verdadeira solidez de uma sociedade reside no apoio mútuo e na retidão de caráter.',
    signatureTitle: 'Por Amâncio de Oliveira Neto',
    signatureText: 'Articulista de Cidadania e Relações Humanas. Focado na defesa de laços comunitários sólidos, transparência ética e valorização da cooperação mútua.',
    color: 'linear-gradient(135deg, #1e293b, #2563eb)'
  },
  {
    idSlug: 'lindenberg-oliveira',
    name: 'Lindenberg de Oliveira',
    roleTag: 'Trabalho & Economia Real',
    subtitle: 'Colunista de Cultura do Trabalho, Desenvolvimento Humano e Legado Familiar',
    initials: 'LO',
    image: '',
    email: 'lindenbergde@hotmail.com',
    phone: null,
    linkedin: null,
    website: null,
    areas: 'Dignidade do Trabalho, Gestão Prática, Valores Geracionais e Desenvolvimento Regional',
    formation: 'Gestão Operacional, Economia do Cotidiano e Planejamento para Gerações Futuras',
    formationLabel: 'Visão Construtiva',
    bio: 'Observador atento dos desafios do homem comum e da nobreza que reside no labor diário. Com trajetória forjada no esforço contínuo, na perseverança construtiva e no compromisso inegociável com a honestidade, traz análises profundas sobre a dignidade do sustento, a preservação dos valores do lar e a transmissão de princípios éticos para o porvir. Seus textos valorizam o trabalho honesto como alicerce fundamental de sustentação moral e progresso verdadeiro.',
    signatureTitle: 'Por Lindenberg de Oliveira',
    signatureText: 'Colunista de Desenvolvimento Humano e Economia Real. Escreve sobre a nobreza do trabalho dedicado, integridade de conduta e construção de legados para as próximas gerações.',
