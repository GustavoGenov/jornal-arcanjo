...
export default function EditForm({ article, categories }) {
  ...
  const [featuredPosition, setFeaturedPosition] = useState(article.featured_position || 'none');
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      if (imageFile) {
        setMessage('Otimizando e comprimindo a nova imagem...');
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <select 
              ...
              style={{ ...inputStyle, borderColor: featuredPosition !== 'none' ? '#1a73e8' : 'var(--border)', fontWeight: featuredPosition !== 'none' ? '600' : 'normal' }}
            >
