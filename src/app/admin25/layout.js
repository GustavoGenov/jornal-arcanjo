...
export default function AdminLayout({ children }) {
  return (
    <ProtectedRoute>
      <link 
        rel="stylesheet" 
        href="https://fonts.googleapis.com/icon?family=Material+Icons&family=Material+Icons+Extended&family=Material+Icons+Outlined&display=swap" 
      />
      <div style={{
        minHeight: '100vh',
        ...
        <div style={{
          ...
          {/* Admin Content */}
          <main style={{ flex: '1 1 600px', minWidth: 0, padding: '36px 28px', overflowY: 'auto', background: 'var(--card, #ffffff)' }}>
            {children}
          </main>
        </div>
      </div>
